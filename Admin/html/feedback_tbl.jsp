...
<body class="fix-header">
                                    ...
                                    <thead>
                                        <tr>
                                           <td align="center" style="border-bottom: 2px solid #000000;">#</td>
                                            <td align="center" style="border-bottom: 2px solid #000000;">Name</td>
                                            <td align="center" style="border-bottom: 2px solid #000000;">Type</td>
                                            <td align="center" style="border-bottom: 2px solid #000000;">email</td>
                                            <td align="center" style="border-bottom: 2px solid #000000;">Message</td>
	...
	String qry = "select * from contact where sno >" +low+" and sno <="+high+";" ;
    ...
    %>
        ...
        <tr align="center" style="padding:50px;">
            ...
            <td><a href="view1.jsp?id=<%=rst.getString("sno")%>">View</a></td>
            <td><a href="update1.jsp?id=<%=rst.getString("sno")%>">Edit</a></td>
            <td><a href="delete.jsp?id=<%=rst.getString("sno")%>">Delete</a></td>
    ...
    %>
				...
				<% if(i != 1)
					{	%>
						<li class="page-item"><a class="page-link" href="feedback_tbl.jsp?pno=<%= i-1%>">Previous</a></li>
						<li class="page-item"><a class="page-link" href="feedback_tbl.jsp?pno=<%= i-1%>"><%= i-1%></a></li>
						<%
					}
				%>
						
						<li class="page-item"><a class="page-link" href="feedback_tbl.jsp?pno=<%= i%>"><%= i %></a></li>
						<li class="page-item"><a class="page-link" href="feedback_tbl.jsp?pno=<%= i +1%>"><%= i + 1%></a></li>
						<li class="page-item"><a class="page-link" href="feedback_tbl.jsp?pno=<%= i +1%>">Next</a></li>
				  </ul>
